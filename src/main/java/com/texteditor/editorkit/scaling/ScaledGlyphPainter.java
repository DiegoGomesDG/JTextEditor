...
public class ScaledGlyphPainter extends GlyphView.GlyphPainter {
    ...
    private int[] getJustificationData(GlyphView v) {
        ...
        /* COMMENTED AS REFLECTION IS MORE RESTRICTED IN JAVA VERSIONS AND THIS APPROACH
        * DOES NOT WORK ON THE CURRENT MODERN VERSIONS OF JAVA */
    ...
    FontMetrics metrics;
    static char[] spaceChar = new char[] {' '};
            ...
            if (txt[i] == '\t'
                ...
                if (txt[i] == '\t') {
                    if (e != null) {
                        ...
                        nextX += metrics.getStringBounds(spaceChar, 0, 1, painterGr).getWidth();
                        nextX =(int)nextX;
                    }
                } else if (txt[i] == ' ') {
                    nextX += metrics.getStringBounds(spaceChar, 0, 1, painterGr).getWidth() + spaceAddon;
                    nextX =(int)nextX;
            ...
            if (txt[i] == '\t'
                ...
                if (txt[i] == '\t') {
                    if (e != null) {
                        ...
                        nextX += (float) metrics.getStringBounds(spaceChar, 0,1, painterGr).getWidth();
                        nextX =(int)nextX;
                    }
                } else if (txt[i] == ' ') {
                    nextX += (float) metrics.getStringBounds(spaceChar, 0,1, painterGr).getWidth()+spaceAddon;
                    if (i <= spaceAddonLeftoverEnd) {
                        nextX++;
                    }
                }
